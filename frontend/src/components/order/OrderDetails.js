...
const OrderDetails = () => {
    ...
    const { loading, error, order = {}  } = useSelector(state => state.OrderDetailsReducer);
         ...
         {loading ? <Loader/> : (
             <Fragment>
                    ...
                    <div className="col-12 col-lg-8 mt-5 order-details">
                        ...
                        <p className={isPaid ? 'greenColor' : 'redColor'} ><b>{isPaid ? 'PAGADO' : 'PENDIENTE A PAGAR'}</b></p>
                        ...
                        <div className="cart-item my-1">
                                 {orderItems && orderItems.map(orderItem => (
                                  <div className="row my-5" key={orderItem.product}>
