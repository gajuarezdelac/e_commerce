...
const UpdateProduct = ({ match, history }) => {
  ...
  const { error, product } = useSelector(state => state.ProductDetailReducer)
  const { loading, error: updateError, isUpdated } = useSelector(state => state.DeleteProductReducer);
